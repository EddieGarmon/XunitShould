...
namespace XunitShould.Sdk
{
    ...
    public class ContainsException : XunitException
    {
        ...
        public ContainsException(object expected)
            : base(String.Format(CultureInfo.CurrentCulture, "Contains() Failure: Not found: {0}", expected)) { }
        ...
        public ContainsException(object expected, object actual)
            : base(String.Format(CultureInfo.CurrentCulture, "Contains() Failure:{2}Not found: {0}{2}In value:  {1}", expected, actual, Environment.NewLine)) { }
    }
}